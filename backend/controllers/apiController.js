...
exports.refreshPostings = function(req, res) {
  let refreshPromise = databaseController.refreshPostingsFromHN(1, false);
...
exports.parseId = function(req, res) {
  let parsePromise = databaseController.parseId(req.params.id);
